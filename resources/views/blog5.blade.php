            ...
            <div class="row g-5 blog_wrapper">
                ...
                <div class="col-lg-8">
                    ...
                    <article class="blog-details">
                        ...
                        <div class="content">
                            <p>
                                A map of the organization of servers of a company winbance
                                ach server a main country
                            ...
                            <br>
                            <br>
                            <h2 class="title">The purpose of the servers</h2>
                            <p>
                                The purpose of these servers is to support the provision of service in the
                                fastest time with the speed of data transmission and reception
                            </p>
