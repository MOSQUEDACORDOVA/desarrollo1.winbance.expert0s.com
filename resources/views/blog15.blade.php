            ...
            <div class="row g-5 blog_wrapper">
                ...
                <div class="col-lg-8">
                    ...
                    <article class="blog-details">
                        <h2 class="title">Forum in the server of the Arabs about launchpad</h2>
                        <div class="content">
                            <p>
                                The CEO of winbance and kanber, the manager of the Turkey server,
                                made an online forum in the Arab server, and it is considered the
                                first forum for a winbance company, through which a lot of information
                                was transmitted to our community in the Arab region. There are many
                                questions and those who answer them
                            </p>


                            <img src="assets/images/blog/blog-details/blog10.svg" class="img-fluid" alt="">

                            <br>
                            <br>
                            <h2 class="title">The most important topics discussed</h2>
                            <p> <span style="font-size: 5em;">.</span> Service launch day</p>
                            <p> <span style="font-size: 5em;">.</span>Are there really fees?</p>
                            <p> <span style="font-size: 5em;">.</span>The Arab and Gulf countries that will be present
                                in the servant of the Arabs</p>
