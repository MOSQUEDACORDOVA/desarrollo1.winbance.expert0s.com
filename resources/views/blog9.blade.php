            ...
            <div class="row g-5 blog_wrapper">
                ...
                <div class="col-lg-8">
                    ...
                    <article class="blog-details">
                        ...
                        <h2 class="title">Announcing the countries in the server UK</h2>
                        ...
                        <div class="content">
                            <p>
                                Welcome back to the new Winbance server UK in which there is
                            </p>
                            <ul>
                                <li>UK</li>
                                <li>USA</li>
                            ...
                            <img src="assets/images/blog/blog4.svg" class="img-fluid" alt="">

                            <br>
                            <br>
                            <p>
                                It is an international server that accepts all global countries and is
                                considered the main in other servers. It is also considered the
                                official and main server in winbance company, and that was
                                the advisor server that provides support to all servers, and it
                                is the one who saves traders’ information on all servers and
                                 has the main in creating accounts funded
                            </p>
