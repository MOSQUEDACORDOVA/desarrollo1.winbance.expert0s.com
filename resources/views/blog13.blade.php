                ...
                <div class="col-lg-8">
                    ...
                    <article class="blog-details">
                        ...
                        <h2 class="title">Announcing the countries in the
                            server latinoamerica</h2>



                        <div class="content">
                            <p>
                                Announcing the second server in winbance, which is the Latin American server that is located
                                in it:
                            </p>
                            <ul>
                                <li>
                            ...
                            <img src="assets/images/blog/blog-details/blog8.svg" class="img-fluid" alt="">

                            <br>
                            <br>
                            <p>
                                It is considered a strong server in company servers, as it includes countries most interested in services, funded accounts, and there are academies in the Latin American server that will be academies in partnership with us, which will provide new traders to test their talents from what they have learned in educational courses
                            </p>
                            <img src="assets/images/blog/blog-details/blog3.svg" class="img-fluid" alt="">

                            <br>
                            <br>
                            <p>There will be changes in a new Latin American server that will be announced soon, and there will be a number of deals with academies and schools in the field of trading</p>
