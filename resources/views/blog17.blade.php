            ...
            <div class="row g-5 blog_wrapper">
                ...
                <div class="col-lg-8">
                    ...
                    <article class="blog-details">
                        ...
                        <h2 class="title">winbance story</h2>



                        <div class="content">
                            <p>
                                The idea of creating WINBANCE started in 2019 in the house of the current CEO AE(Aymanee lotfi)with some merchants and subtract AE Some traders have the idea of a financing program At first, it won the admiration of its trading friends And the project to establish the winbance financing program began In the year 2020 with a group of traders

                            </p>

                            <p>
                           Despite the many difficulties in this service, in 2022 we were not able to complete the establishment of the financing system with a partnership Many of the leading companies in the field of trading
                            </p>



                            <p>
                                Winbance is a UK-registered evaluation company that was established by AE and he is the current CEO of our company. Our goal is to facilitate and solve problems for traders. We have created a professional financing program in several international servers and there are global advisory servers that will be announced soon
                            </p>
                            ...
                            <br>
                            <br>
                            <h2 class="title">The goal behind creating Winbance servers</h2>
                            <p>
                                The purpose of establishing servers is to facilitate our services to traders in terms of marketing, support, and operation trading
                            </p>
