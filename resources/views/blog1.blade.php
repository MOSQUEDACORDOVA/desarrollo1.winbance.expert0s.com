            ...
            <div class="row g-5 blog_wrapper">
                ...
                <div class="col-lg-8">
                    ...
                    <article class="blog-details">
                        ...
                        <h2 class="title">Partnership with wise bank</h2>

                        <br>
                        <br>
                            <img src="assets/images/blog/blog-details/blog1.svg" alt="" class="img-fluid">

                        <div class="content">
                            <p>
                                A new partnership was announced with a different quality company, a company that combines winbance, a bank and wise , and it is the first partnership with a bank through which winbance  provides facilitation for the trader and the establishment of a bank account with low deduction and without complications


                            </p>

                            <img src="assets/images/blog/blog-details/blog2.svg" class="img-fluid" alt="">

                            <br>
                            <br>
                            <h2 class="title">Is it available in all countries?</h2>
                            <p>
                                Yes, it is available in all countries on winbance servers
                            </p>
